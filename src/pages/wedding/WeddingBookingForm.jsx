...
const WeddingBookingForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`${API}/wedding-booking`, formData);

      setSuccess(
        "Wedding enquiry submitted successfully. Our team will verify the payment and contact you shortly."
      );
    ...
    <section className="bg-gray-50 py-24 px-6">
      <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl p-10">
        ...
        <h2 className="text-3xl md:text-4xl font-extrabold text-center text-[#064A8C] mb-4">
          Wedding & Marriage Garden Booking
        </h2>

        <p className="text-center text-gray-600 max-w-3xl mx-auto mb-10">
          Please confirm venue availability by calling or WhatsApp before filling
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-sm text-gray-500 mb-6">
            📞 Call or WhatsApp us to check date availability, then click below.
          </p>
        ...
        {confirmed && (
          ...
          >
            ...
            >
              ...
              {/* Event Type */}
              <div className="flex items-center border rounded-xl px-4">
                <FaRing className="text-[#064A8C] mr-3" />
                <select
                  name="eventType"
              ...
              {/* Catering */}
              <div className="flex items-center border rounded-xl px-4">
                <FaUtensils className="text-[#064A8C] mr-3" />
                <select
                  name="catering"
                  value={form.catering}
                  onChange={handleChange}
                  className="w-full py-3 outline-none bg-transparent"
                >
                  <option value="">Catering Requirement</option>
              ...
              {/* Decoration */}
              <div className="flex items-center border rounded-xl px-4">
                <FaGlassCheers className="text-[#064A8C] mr-3" />
                <select
                  name="decoration"
                  ...
                  className="w-full py-3 outline-none bg-transparent"
                >
                  <option value="">Decoration Preference</option>
                  <option>Basic Decoration</option>
                  <option>Premium Decoration</option>
                  <option>Theme Based Decoration</option>
                </select>
              </div>
              ...
              <div className="md:col-span-2 border rounded-xl p-6 bg-gray-50 space-y-4">
                ...
                <p className="text-center text-red-600 font-semibold">
                  40% Advance Payment Required (Non-Refundable)
                </p>
              ...
              <div className="md:col-span-2">
                ...
                >
                  {loading ? "Submitting..." : "Submit Wedding Enquiry"}
                </button>
              </div>
            </form>
          </div>
        ...
        <div className="text-center mt-12 text-gray-600">
          ...
          <p className="flex justify-center items-center gap-2 mt-2">
            <FaMapMarkerAlt className="text-[#064A8C]" />
             Great Residency Hotel, Jabalpur Road, Katni (MP)
          </p>
        </div>
      </div>
